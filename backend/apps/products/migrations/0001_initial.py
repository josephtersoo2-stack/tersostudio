    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("slug", models.SlugField(help_text="URL-safe slug for the product, unique within the organization.", max_length=190)),
                ("version", models.CharField(default="0.1.0", help_text="Current product semantic version.", max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_at", models.DateTimeField(auto_now_add=True, db_index=True, help_text="Timestamp when record was created")),
                ("updated_at", models.DateTimeField(auto_now=True, help_text="Timestamp when record was last updated")),
                ("product", models.OneToOneField(help_text="Parent WordPress product target.", on_delete=django.db.models.deletion.CASCADE, related_name="plugin_target", to="products.wordpressproduct")),
                ("plugin_slug", models.SlugField(help_text="WordPress plugin folder/main-file slug (e.g. 'tersuite-affiliate').", max_length=100)),
                ("text_domain", models.SlugField(help_text="WordPress gettext localization text-domain.", max_length=100)),
                ("namespace_prefix", models.CharField(help_text="PHP PSR-4 namespace prefix.", max_length=100)),
                ("main_file", models.CharField(help_text="Relative path to plugin entrypoint file (e.g. 'tersuite-affiliate.php').", max_length=150)),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["organization", "kind", "is_archived"], name="products_wo_organiz_381fa2_idx"),
        ),
