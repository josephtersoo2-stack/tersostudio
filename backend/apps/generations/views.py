...
class GenerationViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        qs = Generation.objects.filter(user=self.request.user).select_related("project")
...
class GenerationStepViewSet(viewsets.ModelViewSet):
    """ViewSet for inspecting and managing GenerationSteps."""
    ...
    def get_queryset(self):
        ...
        qs = GenerationStep.objects.filter(generation__user=self.request.user).prefetch_related("runs")
...
class AgentRunViewSet(viewsets.ModelViewSet):
    """ViewSet for inspecting and logging AgentRuns."""
    ...
    def get_queryset(self):
        ...
        qs = AgentRun.objects.filter(step__generation__user=self.request.user)
...
class WorkspaceViewSet(viewsets.ReadOnlyModelViewSet):
    """ViewSet for inspecting Workspace instances."""
    ...
    def get_queryset(self):
        ...
        return Workspace.objects.filter(generation__user=self.request.user)


class ArtifactViewSet(viewsets.ModelViewSet):
    """ViewSet for managing and downloading generated artifacts."""
    ...
    def get_queryset(self):
        ...
        qs = Artifact.objects.filter(generation__user=self.request.user)
