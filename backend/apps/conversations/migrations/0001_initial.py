    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("purpose", models.CharField(choices=[("PROJECT_DISCOVERY", "Project Discovery"), ("PROJECT_PLANNING", "Project Planning"), ("GENERAL", "General Project Discussion")], default="GENERAL", help_text="Functional purpose of the conversation.", max_length=30)),
                ...
                ("next_message_sequence", models.PositiveIntegerField(default=1, help_text="Monotonically increasing sequence index for next message.")),
                ("last_message_at", models.DateTimeField(blank=True, help_text="Timestamp when the most recent message was added.", null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("created_at", models.DateTimeField(auto_now_add=True, db_index=True, help_text="Timestamp when record was created")),
                ("updated_at", models.DateTimeField(auto_now=True, help_text="Timestamp when record was last updated")),
                ("sequence", models.PositiveIntegerField(help_text="Deterministic 1-indexed order within the conversation.")),
                ("role", models.CharField(choices=[("USER", "User"), ("ASSISTANT", "Assistant"), ("SYSTEM", "System"), ("TOOL", "Tool Execution")], default="USER", help_text="Author role tier.", max_length=20)),
                ...
                ("client_message_id", models.CharField(blank=True, default="", help_text="Client-supplied idempotency key.", max_length=64)),
                ...
                ("organization", models.ForeignKey(help_text="Tenant organization owning the message.", on_delete=django.db.models.deletion.CASCADE, related_name="conversation_messages", to="organizations.organization")),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name="conversation",
            index=models.Index(fields=["project", "status"], name="conversatio_project_d512b9_idx"),
        ),
        migrations.AddIndex(
            model_name="conversationmessage",
            index=models.Index(fields=["organization", "-created_at"], name="conversatio_organiz_5c7ce5_idx"),
        ),
        ...
        migrations.AddConstraint(
            model_name="conversationmessage",
            constraint=models.UniqueConstraint(condition=models.Q(("client_message_id", ""), _negated=True), fields=("conversation", "client_message_id"), name="unique_conversation_client_message_id"),
        ),
    ]
