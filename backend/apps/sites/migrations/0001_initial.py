    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("url", models.URLField(help_text="Canonical normalized WordPress site root URL.", max_length=2048)),
                ("environment", models.CharField(choices=[("PRODUCTION", "Production"), ("STAGING", "Staging"), ("DEVELOPMENT", "Development"), ("LOCAL", "Local")], db_index=True, default="PRODUCTION", help_text="Environment deployment classification.", max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("source", models.CharField(choices=[("MANUAL", "Manual Entry"), ("WORDPRESS_CLIENT", "WordPress Client Plugin")], db_index=True, default="MANUAL", help_text="Origin source of snapshot capture.", max_length=20)),
                ("wordpress_version", models.CharField(blank=True, default="", help_text="Detected WordPress core version.", max_length=20)),
                ("php_version", models.CharField(blank=True, default="", help_text="Detected PHP runtime version.", max_length=20)),
                ("multisite", models.BooleanField(default=False, help_text="Whether WordPress multisite network is enabled.")),
                ("locale", models.CharField(default="en_US", help_text="WordPress site locale setting.", max_length=32)),
                ("timezone", models.CharField(default="UTC", help_text="WordPress configured timezone.", max_length=64)),
                ...
                ("organization", models.ForeignKey(help_text="Tenant organization owning the snapshot.", on_delete=django.db.models.deletion.PROTECT, related_name="site_profile_snapshots", to="organizations.organization")),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["organization", "environment", "is_archived"], name="sites_wordp_organiz_6f2e82_idx"),
        ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["organization", "-created_at"], name="sites_sitep_organiz_a43e81_idx"),
        ),
        migrations.AddConstraint(
            model_name="siteprofilesnapshot",
